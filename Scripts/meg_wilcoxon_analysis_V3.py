...
class MEGWilcoxonAnalyzerV3:
    def __init__(self):
        """Initialize the Wilcoxon analyzer V3"""
    ...
    def setup_logging(self):
        ...
        logging.info("MEG Wilcoxon Analysis V3")
        logging.info("=======================")
    ...
    def create_heatmap(self, matrix: np.ndarray, output_path: Path, title: str):
        ...
        # Increase figure size and add more bottom margin for rotated labels
        ...
        # Add extra bottom margin to prevent label clipping
...
def main():
    ...
    analyzer = MEGWilcoxonAnalyzerV3()
