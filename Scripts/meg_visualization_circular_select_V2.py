...
def generate_connectivity_report(matrix, output_path, analysis_type="wilcoxon"):
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(f"CONNECTIVITY REPORT: {analysis_type.upper()}\n")
        f.write("="*80 + "\n\n")
...
def run():
    ...
    generate_connectivity_report(matrix, report_path, analysis_type)
