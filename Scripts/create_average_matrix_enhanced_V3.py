...
"""
MEG Signal Analysis - Enhanced Average Matrix Creator V3
----------------------------------------------------
This script creates average matrices for MEG data, with dynamic folder selection.
V3 is compatible with the new Left_movement/Right_movement folder structure.
...
class AverageMatrixCreatorV3:
    ...
    def setup_logging(self):
        ...
        log_file = self.logs_dir / f"average_matrix_creation_V3_{timestamp}.txt"
        ...
        logging.info("MEG Signal Analysis - Enhanced Average Matrix Creation V3")
        logging.info("=====================================================")
    ...
    def process_dataset(self):
        """Process the entire dataset structure with new Left_movement/Right_movement folders"""
        ...
        for align_dir in self.dataset_dir.iterdir():
            if align_dir.is_dir():
                ...
                # Get all method_freq directories across Left_movement and Right_movement
                method_freq_dirs = {}  # key: method_freq, value: list of directories
                
                # First collect all method_freq directories
                for movement_dir in align_dir.iterdir():
                    if movement_dir.is_dir():
                        movement = movement_dir.name  # 'Left_movement' or 'Right_movement'
                        logging.info(f"Processing movement: {movement}")
...
def main():
    ...
    creator = AverageMatrixCreatorV3()
