...
"""
MEG 3D Brain Visualization Test Script
-------------------------------------
This script tests the 3D brain visualization component of the MEG visualization tool.
It focuses on the gDTF_10Hz_L-R_wilcoxon.csv file and creates
3D brain visualizations with separate positive and negative connections.
"""
...
logging.info("Starting MEG 3D Brain Visualization Test")
...
def run_test():
    ...
    pos_output_path = output_folder / f"{method_freq}_L-R_wilcoxon_3D_brain_positive_TEST_{timestamp}.png"
    ...
    neg_output_path = output_folder / f"{method_freq}_L-R_wilcoxon_3D_brain_negative_TEST_{timestamp}.png"
