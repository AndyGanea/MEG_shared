...
"""
Test script for Enhanced Circular Visualization V2
...
from meg_visualization_circular_select_V2 import select_file, generate_connectivity_report

def test_no_lt_functionality():
    """Test the NO-LT file support functionality"""
    print("Testing Enhanced Circular Visualization V2")
    print("==========================================")
    ...
    for method_freq, analysis_type, is_no_lt in test_cases:
        # Connectivity report
        report_filename = f"{method_freq}_{analysis_type}_connectivity_report_{timestamp}.txt"
        
        # Visualization files
        all_filename = f"{method_freq}_{analysis_type}_circular_connectogram_all_{timestamp}.png"
        pos_filename = f"{method_freq}_{analysis_type}_circular_connectogram_positive_{timestamp}.png"
        neg_filename = f"{method_freq}_{analysis_type}_circular_connectogram_negative_{timestamp}.png"
    ...
    print("- Enhanced connectivity report titles")
